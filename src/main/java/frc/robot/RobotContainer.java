...
public class RobotContainer {
  ...
  public RobotContainer() {
    ...
    autoChooser.addOption("4 Note Sub Right BC/FGH", new PathPlannerAuto("4 - (S) Shoot Preload"));
    ...
    autoChooser.addOption("3 Note Front B/F", new PathPlannerAuto("3 - (Fr) BF ~ 6.20"));
    autoChooser.addOption("3 Note Right C/F", new PathPlannerAuto("3 - (R) CF ~ 6.74"));
    autoChooser.addOption("4 Note Right CBA", new PathPlannerAuto("4 - (R) CBA ~ 4.35"));
    autoChooser.addOption("4 Note Right CB/F", new PathPlannerAuto("4 - (R) CBF ~ 8.60"));
    autoChooser.addOption("5 Note Left ABC/F", new PathPlannerAuto("5 - (L) ABCF ~ 10.20"));
    autoChooser.addOption("5 Note Left BC/EF", new PathPlannerAuto("5 - (L) BCEF ~ 13.96"));
    autoChooser.addOption("6 Note Left ABC/FE", new PathPlannerAuto("6 - (L) ABCFE ~ 15.27"));
    autoChooser.addOption("6 Note Front ABC/GF", new PathPlannerAuto("6 - (Fr) ABCGF ~ 14.59"));
