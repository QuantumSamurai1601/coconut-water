...
public class IntakeSubsystem extends SubsystemBase {
    ...
    public IntakeSubsystem() {
        ...
        leaderPivotRequest = new PositionTorqueCurrentFOC(0).withLimitForwardMotion(forwardLimit.get());
        followerPivotRequest = new Follower(LEFT_INTAKE_PIVOT_ID, true);
        neutral = new NeutralOut();

        // Left/Leader Pivot Config
        pivotConfig = new TalonFXConfiguration();
        pivotConfig.Slot0.kP = 24;
        pivotConfig.Slot0.kI = 0;
        pivotConfig.Slot0.kD = 0.1;
        pivotConfig.MotorOutput.NeutralMode = NeutralModeValue.Brake;
        pivotConfig.MotorOutput.Inverted = InvertedValue.CounterClockwise_Positive;
        pivotConfig.TorqueCurrent.PeakForwardTorqueCurrent = 130;
        pivotConfig.TorqueCurrent.PeakReverseTorqueCurrent = -130;
        ...
        // Intake retracted for start, set position to 0
        leaderIntakePivot.setPosition(0);
